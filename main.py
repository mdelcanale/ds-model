...
model = pickle.load(open("weightsknn.pkl", "rb"))
...
def predict():
    ...
    if output > str(0.5):
        ...
        return render_template('result.html', pred=f'You have a low chance of diabetes which is currently considered safe (this is only an example, please consult a  doccertifiedtor for any medical advice).\n Probability of having diabetes is {output}')
